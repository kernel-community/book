...
We invite you to go through the introduction down below and the DeSci wiki written and curated by Jocelynn Pearl.
...
<Aligner center>
<Button to="https://www.desci.com/blog/what-is-decentralized-science-desci-a-new-era-for-scientific-research">
    Investigate
</Button>
</Aligner>
...
## Staying in Place and Moving 

As with every human endevaour that is transported into the digital, the effort is only as alive as the people contributing to it. 

There are many active DeSci Communites over the world. One could create a world map of such communities with parsing out meetup or events data to get a rough aliveness pulse of the communities. That could be appplied to the DeSci wiki document which is - now - 2 and a half years old. Which may be centuries in some cases but only a wink in other cases. 

Some of the DeSci leaves includes the ones connected to the ATProto (BlueSky)  ecosystem. 

<Link to="https://atproto.science/people/">

https://atproto.science/people/

</Link>

One interesting question one might ask about DeSci is: Why did it happen? Openness and funding issues are named as reasons for creating DeSci, one of the places that tries to adress these issues is for example the 

<Link to="https://www.essentiafoundation.org/about-us-2/">
...
Bernado Kastroup and other guests like Michael Levin discuss the changing landscape of science for example on the essentia podcast. 
